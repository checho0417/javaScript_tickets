...
import { Link,navigate, useParams } from "react-router-dom"; // Importa Link y useParams desde React Router
...
const Respuesta = () => {
  ...
  useEffect(() => {
    ...
    const ticket = ticketsData.find((ticket) => ticket.idTickets === parseInt(id));
